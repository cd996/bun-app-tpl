...
preferences / PKCE state), audit, settings, Zanzibar tuples, items +
item comments, files + file references, and the two sub-type detail
tables (`issue_details`, `document_details`).
