...
See [`modules/item.md`](modules/item.md) §"Adding a sub-type — recipe"
...
bun run check:env-docs  # docs/env-reference.md matches the zod schema + .env.example
bun run check:api-docs  # docs/api-routes.md matches the in-process Hono routes
```
