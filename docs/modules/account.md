...
| Method | Path | Access | Description |
|---|---|---|---|
| GET | `/api/account/users/:id/access` | Admin | Tuples where the user is the subject. |
| GET | `/api/account/groups/:id/access` | Admin | Tuples where the group is the subject. |
