#!/usr/bin/env bun
// Generate docs/api-routes.md from the in-process Hono routes table.
// Walks each module's `*.routes.ts` factory — no live server, no DB.
//
// Usage:
//   bun scripts/gen-api-docs.ts          # write docs/api-routes.md
...
const OUT_PATH = resolve(ROOT, "docs/api-routes.md");
