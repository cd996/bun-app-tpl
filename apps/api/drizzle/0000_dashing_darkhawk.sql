...
CREATE INDEX `idx_audit_actor` ON `audit_events` (`actor_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_doc_folders_creator` ON `document_folders` (`creator_id`);--> statement-breakpoint
